...
export default async function middleware(request) {
  const users = [
    ...
    { email: process.env.ACF_ADMIN3_USER, password: process.env.ACF_ADMIN3_PASSWORD, role: 'admin' },
